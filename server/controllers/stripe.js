...
export const getAccountStatus = async (req, res) => {
  //we send request to stripe and get the user status
  //for that we need our user and our middleware requireSignin gives us the user
  ...
  const updatedUser = await User.findByIdAndUpdate(
    ...
    .select("-password") //deselect password
    .exec();
